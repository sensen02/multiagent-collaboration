...
[Unlicense](LICENSE) —— **公共领域奉献，零条件**。

随便用：复制、修改、发布、商用、闭源再分发、不署名，都可以，不需要征求同意，也不需要保留任何声明。
在承认版权的法域下作者放弃全部版权利益；软件按"原样"提供，不附带任何担保。

之所以不用 MIT：MIT 仍然要求保留版权与许可声明；这里连那一条也不要。
